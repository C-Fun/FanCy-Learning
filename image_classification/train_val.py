...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description='Train Network with Task Pool Mode', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
	...
	folder_name = f'ImageClassification_{arch_name}'
	log_file = os.path.join(root, 'logs_new', folder_name)
	try:
	...
	for epoch in range(1, epochs+1):
		...
		if not args.dont_save or not args.test_only:
			save = True
			ann_path = f'{root}/trained_models_ann/ImageClassification_{arch_name}/'
