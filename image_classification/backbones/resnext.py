...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, num_group=32):
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], num_group, 1)
        self.layer2 = self._make_layer(block, 128, layers[1], num_group, 2)
        self.layer3 = self._make_layer(block, 256, layers[2], num_group, 2)
        self.layer4 = self._make_layer(block, 512, layers[3], num_group, 2)
